...
public class CustomAuthFuncComponent {
    ...
    protected void activate(ComponentContext ctxt) {
        ...
        JsFunctionRegistry jsFunctionRegistry = CustomAuthFuncHolder.getInstance().getJsFunctionRegistry();
        jsFunctionRegistry.register(JsFunctionRegistry.Subsystem.SEQUENCE_HANDLER, "getUsernameFromContext",
                new GetUsernameFromContextFunctionImpl());
    }

    @Deactivate
    protected void deactivate(ComponentContext ctxt) {

        JsFunctionRegistry jsFunctionRegistry = CustomAuthFuncHolder.getInstance()
    ...
    public void setJsFunctionRegistry(JsFunctionRegistry jsFunctionRegistry) {
        ...
        CustomAuthFuncHolder.getInstance().setJsFunctionRegistry(jsFunctionRegistry);
    }

    public void unsetJsFunctionRegistry(JsFunctionRegistry jsFunctionRegistry) {

        CustomAuthFuncHolder.getInstance().setJsFunctionRegistry(null);
    }
}
